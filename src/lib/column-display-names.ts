...
export const columnDisplayNames: Record<string, string> = {
  ...
  'PROGRAMA BOLSA FAMÍLIA - Total de FAMÍLIAS no Programa Bolsa Família - Renda per capita até R$218,00 06/2024': 'Famílias em Pobreza',
  'PROGRAMA BOLSA FAMÍLIA - Total de FAMÍLIAS no Programa Bolsa Família - Baixa renda 06/2024': 'Famílias Baixa Renda',
  'PROGRAMA BOLSA FAMÍLIA - Total de PESSOAS no Programa Bolsa Família 06/2024': 'Total de Pessoas',
  'PROGRAMA BOLSA FAMÍLIA - Total de PESSOAS no Programa Bolsa Família - Renda per capita até R$218': 'Pessoas em Pobreza',
  'PROGRAMA BOLSA FAMÍLIA - Total de PESSOAS no Programa Bolsa Família - Baixa renda 06/2024': 'Pessoas Baixa Renda',
...
    "Estagiário/Aprendiz",
 "BPC/RMV  - Total de beneficiários BPC/RMV": "Total de Beneficiários BPC/RMV",
  ...
  "Proteção Social Básica - Centros de Convivência":
    ...
    "Proteção Social Especial - Unidade de CREAS": "Unidade de CREAS",
  "Proteção Social Especial - Tipo de CREAS": "Tipo de CREAS",
  "Proteção Social Especial - Unidade de Centro Pop": "Unidade de Centro Pop",
  "Proteção Social Especial - Unidade de Centro Dia": "Unidade de Centro Dia",
