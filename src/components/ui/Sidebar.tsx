...
        {/* Menu de navegação com rolagem vertical */}
        <nav className="mt-6 w-full flex-1 overflow-y-auto px-4">
...
            </li>
            <li>
              <Link href="/dashboard-estadual" className="flex items-center text-gray-700 hover:text-blue-600">
                <AiOutlineBarChart className="mr-3" size={20} />
                {isOpen && "Dashboard Estadual"}
              </Link>
            </li>
            <li>
              <Link href="/dashboard-municipal" className="flex items-center text-gray-700 hover:text-blue-600">
                <AiOutlineFund className="mr-3" size={20} />
                {isOpen && "Dashboard Municipal"}
              </Link>
            </li>
            <li>
              <Link href="/maps" className="flex items-center text-gray-700 hover:text-blue-600">
                <MdOutlineMap className="mr-3" size={20} />
                {isOpen && "Mapa"}
              </Link>
            </li>
            <li>
              <Link href="/relatorios-estadual" className="flex items-center text-gray-700 hover:text-blue-600">
                <AiOutlineFileText className="mr-3" size={20} />
                {isOpen && "Relatórios Estaduais"}
              </Link>
            </li>
            <li>
              <Link href="/relatorio-municipal" className="flex items-center text-gray-700 hover:text-blue-600">
...
                className="flex items-center justify-between text-gray-700 hover:text-blue-600 py-2 w-full"
              >
