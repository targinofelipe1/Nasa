...
import CasaDaCidadaniaESineUpdateModalContent from "@/components/ui/CasaDaCidadaniaESineUpdateModalContent";
...
const programId = "casa-da-cidadania-e-sine";

export default function CasaDaCidadaniaESinePage() {
  ...
  const [activeTab, setActiveTab] = useState<keyof typeof tabGroups>('Casa da Cidadania');
    ...
    <ProtectedRoute allowedRoles={["admin"]}>
      ...
      {selectedRow && hasPermission && (
        <Dialog open={isUpdateModalOpen} onOpenChange={handleCloseUpdateModal}>
          <DialogContent>
            <DialogHeader />
            <CasaDaCidadaniaESineUpdateModalContent
              rowData={selectedRow}
