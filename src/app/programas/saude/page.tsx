...
import SaudeUpdateModalContent from "@/components/ui/SaudeUpdateModalContent";
...
export default function SaudePage() {
  ...
  const [activeTab, setActiveTab] = useState<keyof typeof tabGroups>("Infraestrutura");
