// src/app/programas/protecao-especial/page.tsx
...
import ProtecaoEspecialUpdateModalContent from "@/components/ui/ProtecaoEspecialUpdateModalContent";
...
const programDisplayNames: Record<string, string> = {
  "protecao-especial": "Proteção Social Especial",
};
...
const programId = "protecao-especial";

export default function ProtecaoEspecialPage() {
  ...
  const [activeTab, setActiveTab] = useState<keyof typeof tabGroups>("CREAS");
    ...
    <ProtectedRoute>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              {loading ? (
                ...
                <div className="overflow-x-auto bg-white p-6 rounded-lg shadow-md">
                  {/* abas com verificação de permissão */}
                  <div className="mb-6">
      ...
      {selectedRow && hasPermission && (
        <Dialog open={isUpdateModalOpen} onOpenChange={handleCloseUpdateModal}>
          <DialogContent>
            <DialogHeader />
            <ProtecaoEspecialUpdateModalContent
              rowData={selectedRow}
