...
export default function RelatorioPage() {
    ...
    const fetchLocais = async () => {
        ...
        try {
            ...
            console.error('Erro ao carregar dados da planilha de locais para a página de relatório:', error);
                    ...
                    <div className="p-6 space-y-10 flex flex-col items-center h-[calc(100vh-160px)]"> 
                        {carregandoLocais ? (
                            <div className="flex flex-col justify-center items-center h-full">
                                <Spinner />
                                <p className="text-gray-600 mt-4">Preparando gerador de relatórios...</p>
                            </div>
